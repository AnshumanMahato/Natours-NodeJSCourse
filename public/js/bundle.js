...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5zaHVtYW5tYWhhdG8iLCJhIjoiY2w1OTg2bzBkMHdsazNobnJ1Z3JnYTUxNiJ9.gxH9exfwZDLwMt4AJTuWMA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/anshumanmahato/cl5806vke003b14n7oro5dntc',
    scrollZoom: false
  });
...
var saveReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tour, rating, review) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'review saved in successfully!');
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
  ...
  return function saveReview(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.saveReview = saveReview;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editResource = exports.deleteResource = void 0;
...
var deleteResource = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resource, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/".concat(resource, "s/").concat(id)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', "".concat(resource[0].toUpperCase() + resource.slice(1), " Deleted successfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function deleteResource(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var editResource = /*#__PURE__*/function () {
  ...
  return function editResource(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var addReviewBtn = document.getElementById('review-tour');
var nav = document.querySelector('.navigation__nav');
var deleteBtns = document.querySelectorAll('.delete'); // DELEGATION
...
if (reviewForm) reviewForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return (0, _review.saveReview)(tourId, rating, review);
...
if (editForm) editForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            console.log(data, id);
            _context3.next = 10;
            return (0, _manage.editResource)(id, data);
...
if (deleteBtns.length) {
  var resource = document.querySelector('table').dataset.resource;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                e.preventDefault();
                id = btn.dataset.id;
                (0, _alerts.showPrompt)('warn', "Would you like the delete the ".concat(resource, "?"));
                document.querySelector('.btn--confirm').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
                  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          _context4.next = 2;
                          return (0, _manage.deleteResource)(resource, id);
                ...
                document.querySelector('.btn--cancel').addEventListener('click', _alerts.hideAlert);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "64736" + '/');
