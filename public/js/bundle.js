      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'User Deleted in successfully!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
...
var editResource = /*#__PURE__*/function () {
  ...
  return function editResource(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
if (deleteBtns) deleteBtns.forEach(function (btn) {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              id = btn.dataset.id;
              (0, _alerts.showPrompt)('warn', 'Would you like the delete the userid?');
                ...
                return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        _context4.next = 2;
                        return (0, _manage.deleteResource)(id);
